...
class BaseBrowserController(ABC):
    ...
    def handle_recovery_email_prompt(self, page):
    ...
    def outlook_register(self, page, email, password):
        ...
        recovery_email_required = self.handle_recovery_email_prompt(page)
        ...
        try:
            inbox_timeout = 300000 if recovery_email_required else 32000
